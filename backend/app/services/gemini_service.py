...
def _build_outfitsme_generation_prompt(
    *,
    ...
    return (
        ...
        "Show the full person from head to toe in a full-body composition, with the entire outfit visible including legs, feet, and shoes when requested. "
        "Do not crop to a portrait, chest-up, waist-up, or top-only framing. "
        ...
        "Keep the face natural and neutral. Do not add smiles, grins, laughter, exaggerated emotion, or any strong facial expression. "
